...
// Query
$query = "SELECT * FROM standar_bbpb ORDER BY tngg_bdn ASC";
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-4 text-gray-800 text-center font-weight-bold">
                    Standar Berat Badan / Panjang Badan (BB/PB)
                </h1>

                <div class="card shadow mb-4">
                    <div class="card-header bg-primary text-white">
                        <h6 class="m-0 font-weight-bold">Daftar Standar BB/PB</h6>
                    </div>

                    <div class="card-body">
                        <p><strong>Total Data:</strong> <?= $total ?></p>
                        <p>Data ini digunakan untuk menentukan z-score BB/U, TB/U dan BB/TB balita umur <strong>0 - 24 bulan</strong></p>
