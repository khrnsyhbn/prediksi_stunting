...
$query = "SELECT * FROM kelurahan ORDER BY id_kelurahan ASC";
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-primary text-white">
                        <h6 class="m-0 font-weight-bold">Daftar Kelurahan</h6>
                    </div>
                    <div class="card-body">

                        <p><strong>Total Kelurahan:</strong> <?= $total ?> kelurahan</p>
                            ...
                            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            <td class="text-center"><?= htmlspecialchars($row['id_kelurahan']) ?></td>
