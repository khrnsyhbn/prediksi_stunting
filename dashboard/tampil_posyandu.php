            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-primary text-white">
                        <h6 class="m-0 font-weight-bold">Daftar Posyandu</h6>
                    </div>
                    <div class="card-body">

                        <p><strong>Total Posyandu:</strong> <?= $total ?> posyandu</p>
                            ...
                            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            <td><?= htmlspecialchars($row['id_posyandu']) ?></td>
                                            <td><?= htmlspecialchars($row['nama_posyandu']) ?></td>
                                            <td><?= htmlspecialchars($row['jenis_posyandu']) ?></td>
